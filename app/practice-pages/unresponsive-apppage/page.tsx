...
export default function AppPage() {
  ...
  // Handles the first goal submission
  ...
  // Handles the code submission and starts the navigation
  const handleCodeSubmit = async () => {
    ...
    try {
      ...
      // Delay before routing for smooth UX
      setTimeout(() => {
        router.push('/result');
      }, 1000);
    } catch (error) {
      ...
      <SignedIn>
        <div className="min-h-screen flex flex-col">
          ...
          <div className="flex items-center h-[9.5vh] bg-gray-100 px-8 shadow-sm">
            ...
            <div className="w-[0.3vw]" /> {/* Spacer */}
            <div className="w-[80vw]" />  {/* Push user button to end */}

            {/* User Button with popover */}
            <div
              className="inline-flex w-[110px] items-center justify-center gap-3 rounded-lg border border-gray-200 bg-gray-100 px-4 py-2 text-lg font-semibold text-black shadow-sm transition-all duration-200 hover:bg-gray-50 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              onClick={() => {
            ...
            >
              ...
              <div ref={triggerRef} className="relative">
                <UserButton 
                  ...
                  appearance={{
                    elements: {
                      userButtonPopoverCard: { transform: 'translateY(30px)' }
                    }
                  }}
                />
              </div>
                ...
                {isNavigating ? (
                  ...
                  <>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <div className="h-[4vh]" /> {/* Vertical Spacer */}
                      ...
                      <div className={`transition-all duration-800 ${codeSubmitted ? 'blur-md opacity-50 pointer-events-none' : ''}`}>
                        ...
                        <div className='h-[2vh]' /> {/* Spacer before button */}

                        <Button
                          onClick={goalSubmitted ? handleCodeSubmit : handleGoalSubmit}
                          disabled={
                            isTransitioning || codeSubmitted ||
                            !(goalSubmitted ? codeText.trim() : goalText.trim())
                          }
                          className="rounded-lg border border-gray-200 bg-gray-100 px-4 py-2 text-md text-black shadow-sm transition-all duration-200 hover:bg-gray-50 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50"
                        >
