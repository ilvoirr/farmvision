              ...
              <div className="relative z-20 flex flex-col items-center justify-center text-center px-4 h-full">
                ...
                <AnimatePresence mode="wait">
                  {!showScore ? (
                    ...
                    >
                      <ShineBorder
                        className="relative flex flex-col items-center justify-center overflow-hidden rounded-lg border bg-background p-8 md:p-12"
                        color={"#A07CFE"}
                      >
                        <motion.div
                          initial={{ opacity: 0, y: 20 }}
                        ...
                        >
                          ...
                          <div className="mb-8">
                            <motion.div
                              ...
                              className="text-6xl md:text-7xl font-bold text-purple-600 mb-2"
                            >
                              {score}/10
                            </motion.div>
                          ...
                          {feedback && (
                            ...
                            >
                              ...
                              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 text-gray-700 dark:text-gray-300 whitespace-pre-wrap">
                                {feedback}
                              </div>
                            </motion.div>
                          )}
                          ...
                          <Button
                            onClick={resetForm}
                            className="mt-6 rounded-lg border border-gray-200 bg-gray-100 px-6 py-3 text-md text-black shadow-sm ring-inset ring-gray-300 transition-all duration-200 hover:bg-gray-50 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                          >
