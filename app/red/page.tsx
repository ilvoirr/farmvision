...
function HomePageDesktop() {
  ...
  return (
    <>
      ...
      <div className="flex items-center h-[8vh] bg-gray-50 text-white px-8 shadow-sm">
        {/* Left spacing */}
        ...
        <svg
          ...
          className="text-red-700 w-[6vh] h-[6vh] md:w-[4.9vh] md:h-[4.9vh]"
        >
        ...
        <h1 className="hidden md:inline-flex text-[1.3vw] font-semibold tracking-tight text-red-700">
          Code Progress Bar
        </h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <SignedOut>
            <SignInButton>
              <Button className="only-1366 bg-transparent text-red-700 hover:text-white hover:bg-red-700 md:text-[1.77vh] text-[4vw]">
                Login
              </Button>
            </SignInButton>
            <SignUpButton>
              <Button className="only-1366 bg-red-700 text-white md:w-[5.75vw] w-[25vw] hover:bg-red-800 hover:text-white md:text-[1.77vh] text-[4vw]">
                Sign Up
              </Button>
            </SignUpButton>
          </SignedOut>
      ...
      ============================================================ */}
      {/* Main hero container */}
      <div className="flex-col w-full md:h-auto h-screen bg-gray-50">
        {/* Top spacing */}
...
function HomePageMobile() {
  ...
  return (
    <>
      ...
      <div className="flex items-center h-[8vh] bg-gray-50 text-white px-8 shadow-sm">
        ...
        <div className="flex items-center gap-4">
          ...
          <SignedOut>
            ...
            <SignUpButton>
              <Button className="only-1366 bg-red-700 text-white md:w-[5.75vw] w-[25vw] hover:bg-red-700 hover:text-white md:text-[1.77vh] text-[4vw]">
                Sign Up
              </Button>
            </SignUpButton>
          </SignedOut>
      ...
      <div className="flex-col w-full h-[92vh] bg-gray-50">
